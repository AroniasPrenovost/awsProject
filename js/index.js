...
quotesArr[6] = '<span style="font-style:italic" "font-size:20px">"Obsolete comments are worse than no comments.</span>" <br><br> - Zed Shaw | Everett, WA';
